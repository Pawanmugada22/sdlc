...
CREATE TABLE ACC_PER_TASK_COM (
    ...
    PRIMARY KEY (APTC_TASK_CODE,APTC_TASK_PER_CODE)
);

CREATE TABLE ACC_PER_TASK_EXP (
    APTE_TASK_CODE INT REFERENCES ACC_PER_TASK_COM(APTC_TASK_CODE),
...
CREATE TABLE ACC_PER_TASK_HIS (
    APTH_TASK_CODE INT REFERENCES ACC_PER_TASK_COM(APTC_TASK_CODE),
